<template>
  <div class="home">
    ...
    <el-table :data = "tableData" stripe border v-loading="loading" text>
      <el-table-column prop = "id" label = "编号" v-if = "disabled"></el-table-column>
...
<!--              @click="$router.push('/editadmin?id=' + scope.row.id)">编辑</el-button>-->
          <el-popconfirm
              title="您确定要删除此用户吗？"
