<template>
  <div class="home">
    ...
    <el-table :data = "tableData" stripe border v-loading="loading" text :default-sort = "{prop: 'number', order: 'descending'}">
      ...
      <el-table-column prop = "money" label = "消费金额" sortable></el-table-column>
      <el-table-column prop = "establishtime" label = "订单消费日期" sortable></el-table-column>
      <el-table-column prop = "reservetime" label = "预订日期" sortable></el-table-column>
      <el-table-column prop="state" label="状态"
                       :filters="[{ text: '未核验', value: 0 }, { text: '已核验', value: 1 }]"
...
import dialogComponent from "./CheckUserOrders";
