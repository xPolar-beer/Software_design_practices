...
<!--    <div style="height: 100vh; overflow: hidden">-->
      <div style="width: 450px; height: 600px; background-color: white; border-radius: 10px; padding-top: -50px">
        <div>
          <h1 class="center" style="padding-top: 40px">创建您的账户</h1>
          ...
          <div style="text-align: center">
            <el-button type="success" @click="save('form')">注册</el-button>
            <el-button @click="clear('form')">重置</el-button>
          </div>
          <div class="center">
            <el-button type="text" @click="goback()">已有账户？点击这里</el-button>
          </div>
        </div>
      </div>
<!--    </div>-->
...
<style scoped>
.login_imgSrc{
  background-image: url("D:\homework\vue\src\assets\login_background.jpg");
  width: 100%;
  height: 100%;
  position:fixed;
